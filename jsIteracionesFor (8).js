function Mostrar()
{	
	var numeroAnterior = 2;
	var tieneDivisor = "no";
	var numRecorrido;
	var numeroIngresado = prompt("Ingrese un nùmero.");
...
/*
{
	...
	prom1 = (cont1 / 100000) * 100;
	prom2 = (cont2 / 100000) * 100;
	prom3 = (cont3 / 100000) * 100;
	prom4 = (cont4 / 100000) * 100;
	prom5 = (cont5 / 100000) * 100;
	prom6 = (cont6 / 100000) * 100;
	prom7 = (cont7 / 100000) * 100;
	prom8 = (cont8 / 100000) * 100;
	prom9 = (cont9 / 100000) * 100;
	prom10 = (cont10 / 100000) * 100;
